...
public class HexFactory {
    ...
    public char[] encodeHex(String str, Charset charset) {
        ...
        return encodeHex(charset == null ? str.getBytes() : str.getBytes(charset), true);
    }
    ...
    public String encodeHexStr(String data, Charset charset) {
        ...
        return encodeHexStr(charset == null ? data.getBytes() : data.getBytes(charset), true);
    }
    ...
    public String decodeHexStr(char[] hexData, Charset charset) {
        ...
        byte[] hexBytes = decodeHex(hexData);
