package me.wuwenbin.tools.encrypt.factory;

import me.wuwenbin.tools.encrypt.asymmetric.AsymmetricAlgorithm;
import me.wuwenbin.tools.encrypt.digest.DigestAlgorithm;
import me.wuwenbin.tools.encrypt.digest.Digester;
import me.wuwenbin.tools.encrypt.digest.HMac;
...
public class SecurityUtils {
    ...
    public static SymmetricEncryption aes() {
        return new SymmetricEncryption(SymmetricAlgorithm.AES);
    }
    ...
    public static SymmetricEncryption aes(byte[] key) {
        return new SymmetricEncryption(SymmetricAlgorithm.AES, key);
    }
    ...
    public static SymmetricEncryption des() {
        return new SymmetricEncryption(SymmetricAlgorithm.DES);
    }
    ...
    public static SymmetricEncryption des(byte[] key) {
        return new SymmetricEncryption(SymmetricAlgorithm.DES, key);
    }
