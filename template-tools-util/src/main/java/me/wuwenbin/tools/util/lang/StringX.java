...
import me.wuwenbin.tools.util.lang.constant.CharConst;
import me.wuwenbin.tools.util.lang.constant.HtmlConst;
import me.wuwenbin.tools.util.lang.constant.StringConst;
import me.wuwenbin.tools.util.lang.constant.TextConst;
...
/**
 * 字符串工具类,<a href="www.hutool.cn">hutool</a>来源
 * 剔除其他关联类,使得此类尽量可以单独使用,不受其他类限制
 * 剔除了某些不常用的方法,挪移某些方法至更恰当的类中,更易辨析作用
 * 修改以适应<tt>template-xxx</tt>系列项目规范
 *
 * @author xiaoleilu
 * @since 1.0
 */
public class StringX implements CharConst, HtmlConst, StringConst, TextConst {
    // ------------------------------------------------------------------------ Blank
    ...
    public String format(String template, Object... params) {
        ...
        return Util.placeholder.format(template, params);
    }
