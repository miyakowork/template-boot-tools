package org.templateproject.tools.sqlgen.factory;


import org.templateproject.tools.sqlgen.exception.DeleteSQLConditionsNullException;
import org.templateproject.tools.sqlgen.exception.InsertColumnNullException;
import org.templateproject.tools.sqlgen.exception.TableNameNullException;
import org.templateproject.tools.sqlgen.exception.UpdateColumnNullException;
import org.templateproject.tools.sqlgen.util.SQLBuilderUtils;
...
public class SQLStrBuilder {
    ...
    public String selectPartByColumnsAnd(String tableName, String[] selectColumns, String... conditionColumns) throws TableNameNullException {
        if (tableName == null || "".equals(tableName))
            ...
            } else sb.append(tableName).append(".* ");
    ...
    public String insertColumns(String tableName, String... columns) throws TableNameNullException, InsertColumnNullException {
        if (tableName == null || "".equals(tableName))
            ...
            } else throw new InsertColumnNullException();
            return SQLBuilderUtils.dealSQL(sb.toString());
        }
    }
